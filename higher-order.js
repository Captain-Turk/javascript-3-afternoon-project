...
//Code Here
let evenNumbers = mixedNumbers.filter(numb => numb % 2 === 0 )
...
*/
  ...
  let bobsTotal = justBob.reduce((acc, element)=>{
    return acc + element.price
  },0)
// let bobsTotal = purchases.filter(element => element.owner = 'Bob'){reduce((acc, element['price'])}
//   return  acc + element['price']
// },0)


// let bobsTotal = function(purchases){
//   if (purchases.filter(element => element.owner = 'Bob')){
//     return reduce((acc, element['price']){
//       return acc + element['price']
//     },0)
//   }
//  }